...
class MainWindow:
    ...
    def setup_ui(self):
        ...
        # 标题
        title_label = ttk.Label(main_frame, text="文件重命名工具 (MVC架构)", 
                               font=("Arial", 16, "bold"))
    ...
    def create_path_section(self, parent, row):
        ...
        ttk.Label(path_frame, text="当前路径:").grid(row=0, column=0, sticky=tk.W, padx=(0, 10))
        ...
        ttk.Button(path_frame, text="确认路径", 
    ...
    def create_status_section(self, parent, row):
        ...
        status_frame.grid(row=row, column=0, columnspan=3, sticky=(tk.W, tk.E, tk.N, tk.S), pady=(10, 0))
...
class MainController:
    ...
    def __init__(self):
        ...
        self.view.update_status("欢迎使用文件重命名工具！(MVC架构)\n")
